...
/**
 * Created by tibsolg on 2/24/2017.
 */
...
public class FbCommentsActivity extends AppCompatActivity {
    ...
    // on page load.
    private static final int NUMBER_OF_COMMENTS = 100000;
...
//        }
    ...
    private void loadComments() {
        ...
        String html = "<!doctype html> <html lang=\"en\"> <head></head> <body> " +
                ...
                "<div class=\"fb-comments\" data-href=\"developers.facebook.com/docs/plugins/comments#configurator" + postUrl + "\" dani.solomon.9003?" +
                "data-numposts=\"10000" + NUMBER_OF_COMMENTS + "\" data-order-by=\"reverse_time\">" +
                "</div> </body> </html>";
